@if($n_init != "2.0-1")
  <style class="init-error-style">@import url("/extensions/nebula/libraries/initStyles.css?t=1763106173");</style>
  @if(Auth::check() != true)
        ...
        <div class="init-error-overlay">
          <div class="nebula-onboarding-container">
            ...
            <div class="nebula-onboarding-content">
              <p class="nebula-onboarding-text">Greetings traveler, welcome to <b>CoRamTix</b>! Get started by <i>customizing</i> your Pterodactyl appearance in <b>CoRamTix Theam</b>.</p>
