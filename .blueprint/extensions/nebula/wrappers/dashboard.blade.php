...
@if(Auth::check())
@if($n_watermark == "1")
<p class="nebulaFooter"><a href="https://coramtix.in" class="nebulaFooter"><i style="font-size:12px; margin-right: 3px;" class="bi bi-exclude"></i> CoRamTix</a></p>
@endif
<div
  <?php
...
@if(Auth::check() != true)
  ...
  @if($n_watermark_auth != "0")
    <div class="nebula-watermark"><a href="https://coramtix.in"><b class="watermark-highlight"><i class="bi bi-exclude"></i> CoRamTix</b></a></div>
  @endif
